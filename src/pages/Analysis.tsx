...
export default function Analysis() {
  ...
  const [jobUrls, setJobUrls] = useState<string[]>([
    "https://toss.im/career/job-detail/backend-developer",
  ]);
      ...
      >
          ...
          <div className="flex flex-col">
            ...
            <div className="form-group mt-5">
              <div className="flex items-center justify-between mb-1">
                <label className="form-label block text-xs font-medium text-neutral-700">
                  이력서 텍스트 직접 입력 / 편집
                </label>
        ...
        <div className="mt-8 pt-6 border-t border-neutral-200 flex justify-center">
          <button
            ...
            disabled={
              validating ||
              (resumeValidation !== null && !resumeValidation.valid)
            }
