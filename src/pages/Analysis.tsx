  ...
  if (loading) {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-6 text-center max-w-[520px] mx-auto">
        ...
        <h2 className="text-xl font-bold mb-2 text-neutral-900">AI 커리어 코파일럿 진단 중</h2>
            ...
            return (
              ...
              >
                ...
                <span className={`text-xs ${
                  isCurrent ? 'font-semibold text-neutral-900' : 'font-normal text-neutral-500'
                }`}>
                  {step}
                </span>
              </div>
    ...
    return (
      <div className="max-w-[1160px] mx-auto px-4">
        ...
        <div className="mb-8 border-b border-neutral-200 pb-6">
          <button onClick={() => setResult(null)} className="btn btn-secondary inline-flex items-center text-xs gap-1.5">
            <ArrowLeft size={14} /> 진단 다시하기
          </button>
          
          <div className="flex justify-between items-end mt-4 flex-wrap gap-6">
            <div>
              <span className="inline-block bg-blue-50 text-[#0070f3] px-2 py-0.5 rounded text-[11px] font-semibold mb-2">AI 종합 분석 레포트</span>
              <h1 className="text-3xl font-bold tracking-tight m-0 text-neutral-900">AI Career Report</h1>
              <p className="mt-1 mb-0 text-sm text-neutral-500">GitHub 소스코드 및 이력서 기반 종합 커리어 역량 평가 보고서입니다.</p>
            </div>
            ...
            <div className="bg-white border border-neutral-200 rounded-xl py-3 px-5 shadow-xs">
              <div className="flex items-center gap-4">
                <div className="relative flex items-center justify-center">
                  ...
                  <span className="absolute text-xs font-bold text-neutral-900">{overall_score}점</span>
                </div>
                <div className="flex flex-col">
                  <div className="text-[10px] text-neutral-400 uppercase tracking-wider">종합 스택 역량</div>
                  <div className="text-lg font-bold text-neutral-900 leading-none">{portfolio_rating}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 lg:col-span-7">
            ...
            <div className="card">
              <div className="flex justify-between items-center border-b border-neutral-200 pb-3.5 mb-4">
                <div className="flex items-center gap-2 text-neutral-900">
                  <Github size={18} />
                  <h2 className="text-base font-bold">GitHub 포트폴리오 분석 결과</h2>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-5">
                <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-3.5 flex flex-col">
                  <span className="text-[11px] text-neutral-400 mb-1">README 상태</span>
                  <span className="text-sm font-semibold text-neutral-900">{github_analysis.readme_quality}</span>
                </div>
                <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-3.5 flex flex-col">
                  <span className="text-[11px] text-neutral-400 mb-1">프로젝트 완성도</span>
                  <span className="text-sm font-semibold text-neutral-900">{github_analysis.project_completeness}</span>
                </div>
              </div>

              <div className="mt-5">
                <span className="block text-xs font-semibold text-neutral-900 mb-2 uppercase tracking-wide">감지된 주요 기술 스택</span>
              ...
              <div className="mt-6">
                <span className="block text-xs font-semibold text-neutral-900 mb-2 uppercase tracking-wide">레포지토리별 세부 정보</span>
                <div className="flex flex-col gap-3">
                  {github_analysis.repo_details.map(repo => (
                    <div key={repo.url} className="border border-neutral-200 rounded-lg p-3.5 bg-white hover:border-neutral-400 transition-colors duration-150">
                      <div className="flex justify-between items-center mb-1.5">
                        <a href={repo.url} target="_blank" rel="noopener noreferrer" className="text-xs font-semibold text-neutral-900 inline-flex items-center gap-1 hover:underline">
                          {repo.name} <ExternalLink size={12} />
                        </a>
                        <span className="badge badge-success">{repo.quality_score}점</span>
                      </div>
                      <p className="text-[11px] text-neutral-500 m-0 mb-2 leading-relaxed">{repo.description}</p>
                      <div className="text-[10px] text-neutral-400 flex items-center gap-2">
                        <span>주요 언어: <strong className="text-neutral-700">{repo.primary_language}</strong></span>
              ...
              {github_analysis.readme_suggestions && github_analysis.readme_suggestions.length > 0 && (
                <div className="mt-6 pt-5 border-t border-neutral-200">
                  <span className="block text-xs font-semibold text-neutral-900 mb-2 uppercase tracking-wide">깃허브 README 개선 제안</span>
                  <ul className="list-none p-0 mt-2 flex flex-col gap-2">
                    {github_analysis.readme_suggestions.map((suggestion, idx) => (
                      <li key={idx} className="text-xs text-neutral-600 leading-relaxed flex gap-2 items-start">
            ...
            <div className="card">
              ...
              <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-3 flex gap-3 items-start mb-5">
                ...
                <div>
                  <h4 className="m-0 text-xs font-bold text-neutral-900">이력서 품질 코멘트</h4>
                  <p className="m-0 text-[11px] text-neutral-500 leading-normal">{resume_analysis.resume_quality}</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="flex flex-col">
                  <span className="text-xs font-bold mb-1 text-emerald-600">✓ 교차 검증 성공 (Verified)</span>
                  <p className="text-[10px] text-neutral-400 m-0 mb-2 leading-relaxed">이력서와 깃허브 코드 이력에서 교차 확인된 스택</p>
                  <div className="flex flex-wrap gap-1.5">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-bold mb-1 text-amber-600">✗ 소스코드 증명 필요 (Unverified)</span>
                  <p className="text-[10px] text-neutral-400 m-0 mb-2 leading-relaxed">이력서에는 적혀있으나 깃허브 코드 확인이 어려운 스택</p>
                  <div className="flex flex-wrap gap-1.5">
                    {resume_analysis.unverified_skills.length > 0 ? (
                      ...
                      <span className="text-xs text-neutral-400 italic">모든 스택이 증명되었습니다.</span>
                    )}
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-6 lg:col-span-5">
            ...
            <div className="card">
              ...
              <div className="bg-red-50 border border-red-100 rounded-lg p-3.5">
                <span className="block text-xs font-semibold text-neutral-900 mb-2 uppercase tracking-wide">미보유 보완 기술 스택</span>
                <div className="flex flex-wrap gap-1.5">
              ...
              <div className="mt-6">
                <span className="block text-xs font-semibold text-neutral-900 mb-2 uppercase tracking-wide">AI 성장 추천 로드맵</span>
                <div className="flex flex-col gap-3">
                  {skill_gap.learning_roadmap.map((step, idx) => (
                    <div key={idx} className="flex items-start gap-3">
                      <div className="w-4.5 h-4.5 rounded-full bg-neutral-900 text-white flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">{idx + 1}</div>
                      <span className="text-xs text-neutral-600 leading-relaxed">{step}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="card">
              <div className="flex items-center gap-2 text-neutral-900 mb-2">
                <Sparkles size={18} />
                <h2 className="text-base font-bold">커리어 보완 추천 프로젝트</h2>
              </div>
              ...
              <div className="flex flex-col gap-4">
                {recommended_projects.map((proj, idx) => (
                  <div key={idx} className="border border-neutral-200 rounded-lg p-4 bg-neutral-50">
                    <div className="flex justify-between items-center mb-1.5">
                      <h4 className="text-sm font-bold text-neutral-900 m-0">{proj.title}</h4>
                    ...
                    <p className="text-xs text-neutral-500 leading-relaxed m-0 mb-3">{proj.description}</p>
                    ...
                    <div className="bg-white border border-neutral-200 rounded-md py-2 px-3 mb-3">
                      ...
                      <p className="text-[10px] text-neutral-500 leading-relaxed m-0">{proj.architecture}</p>
                    </div>
  ...
  return (
    <div className="max-w-[960px] mx-auto px-4">
      <div className="header-section">
        <h1 className="text-3xl font-bold tracking-tight mb-2 text-neutral-900">Unified AI Career Report</h1>
      ...
      <form onSubmit={handleStartAnalysis} className="bg-white border border-neutral-200 rounded-xl p-8 shadow-xs">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-4 border-b border-neutral-50 pb-2 text-neutral-900 font-bold text-base">
              <Github size={18} />
              <h3 className="m-0 text-sm font-bold text-neutral-900">1. GitHub 포트폴리오 연동</h3>
            </div>
            
            <div className="form-group mb-6">
              <label className="form-label block text-xs font-medium text-neutral-700 mb-1">메인 GitHub Repository URL</label>
              <input
                type="url"
            ...
            <div className="form-group">
              <div className="flex items-center gap-2 mb-4 border-b border-neutral-50 pb-2 text-neutral-900 font-bold text-base">
                <Code2 size={18} />
                <h3 className="m-0 text-sm font-bold text-neutral-900">2. 채용공고 URL 연동 (최대 5개)</h3>
              </div>
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-4 border-b border-neutral-50 pb-2 text-neutral-900 font-bold text-base">
              <FileText size={18} />
              <h3 className="m-0 text-sm font-bold text-neutral-900">3. 이력서(Resume) 업로드</h3>
            </div>
